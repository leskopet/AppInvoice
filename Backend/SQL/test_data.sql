...
INSERT INTO `AppInvoice`.`Invoice` (`id`, `suplier`, `customer`, `title`, `description`, `total`, `vat`, `total_vat`, `status`, `created`, `suplied`, `due_date`) VALUES
    ...
    (6,  2, 10, '2025006', '', 100,  23,  123,  2, '2025-01-06', '2025-01-06', '2025-01-20'),
    (7,  2, 11, '2025007', '', 1000, 230, 1230, 2, '2025-02-05', '2025-02-05', '2025-02-19'),
    (8,  2, 5,  '2025008', '', 100,  23,  123,  2, '2025-03-01', '2025-03-01', '2025-03-15'),
    (9,  2, 6,  '2025009', '', 1000, 230, 1230, 2, '2025-04-04', '2025-04-04', '2025-04-18'),
    (10, 3, 7,  '2025010', '', 100,  23,  123,  2, '2025-01-01', '2025-01-01', '2025-01-15'),
    (11, 3, 8,  '2025011', '', 1000, 230, 1230, 2, '2025-03-03', '2025-03-03', '2025-03-17'),
    (12, 3, 9,  '2025012', '', 100,  23,  123,  2, '2025-04-02', '2025-04-02', '2025-04-16'),
    (13, 4, 10, '2025013', '', 1000, 230, 1230, 2, '2025-02-06', '2025-02-06', '2025-02-20'),
    (14, 4, 11, '2025014', '', 100,  23,  123,  2, '2025-04-05', '2025-04-05', '2025-04-19');
